...
from TSProblemDef import get_random_problems,get_random_noneuclidian_problems
...
class TSPEnv:
    ...
    def load_problems(self, batch_size):
        ...
        # self.problems = get_random_problems(batch_size, self.node_cnt)
        self.problems = get_random_noneuclidian_problems(batch_size, self.node_cnt)
