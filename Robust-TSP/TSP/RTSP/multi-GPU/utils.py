...
result_folder = '../RTSP/rtsp_result/' + process_start_time.strftime("%Y%m%d_%H%M%S") + '{desc}'
...
def create_logger(log_file=None):
    ...
    # TODO: Use with multiple GPUs
    if 'desc' in log_file:
        log_file['filepath'] = log_file['filepath'].format(desc='_' + log_file['desc'] + log_file['local_rank'])
    else:
        log_file['filepath'] = log_file['filepath'].format(desc='')
    # TODO: Use with single GPUs
    # if 'desc' in log_file:
...
def copy_all_src(dst_root):
    ...
    for item in sys.modules.items():
        ...
        if hasattr(value, '__file__') and value.__file__:
            ...
            # TODO: your route for pretrained train.py and rvrp train.py
            old_path = "/home/xiaopei/Documents/Robust-VRP/Robust-TSP/TSP//Pretrained_Tsp_Model/RTSP_train.py"
            new_path = "/home/xiaopei/Documents/Robust-VRP/Robust-TSP/TSP/RTSP/RTSP_train.py"
            if src_abspath == old_path:
                src_abspath = new_path
